...
2. Класс Solution должен содержать публичное статическое поле testString типа TestString, к
оторое сразу проинициализировано.
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        String[] string = arrayOutputStream.toString().split("\n");
